...
public class DepartmentContact extends QuaranoAggregate<DepartmentContact, DepartmentContact.DepartmentContactIdentifier> {
	...
	private @JoinColumn(name = "department_id") @ManyToOne @Getter @Setter Department department;
